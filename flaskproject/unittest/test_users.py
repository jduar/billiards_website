...
class BasicTests(unittest.TestCase):
    ...
    def test_valid_user_registration(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(
            b"Your account has been created. You are now able to log in", response.data
        )

    def test_invalid_user_registration_different_passwords(self):
        response = self.register(
            "patKen", "patkennedy79@gmail.com", "FlaskIsAwesome", "FlaskIsNotAwesome"
        )
    ...
    def test_invalid_user_registration_duplicate_email(self):
        ...
        self.assertIn(
            b"That email is taken. Please choose a different one.", response.data
        )
